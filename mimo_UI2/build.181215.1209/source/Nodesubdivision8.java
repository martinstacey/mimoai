...
//sirve candados
float scand = 1;
String [] rooms = {"B", "H"};  //0:code 1:name 2:area
int [] lockIN = {0, 0};
String [][] roomDATAIN={{"B","Bed","2.4","0.5","10","0.2","H"},{"H","Hall","1.6","0.5","10","0.4","B"},{"Be","Bedroom","10.24","0.5","10","1","Li Fa"},{"Ba","Bathroom","6.4","0.5","10","0.98","Be Fa"},{"Cl","Closet","1.28","0.5","10","0.5","Be"},{"Di","Dining","19.2","0.5","10","0.83",""},{"Ki","Kitchen","2.56","0.5","10","0.25","Li"},{"La","Laundry","1.92","0.5","10","0.33",""},{"Li","Living","20.48","0.5","10","0.5","Fa"},{"Ha","Hall","1.92","0.5","10","0.5","Li"}};
...
class Node {
  ...
  public void displaynodetree() {
    ...
    if (ideals!=null) for (int i=0; i<ideals.length; i++) if (ideals[i]!=null)  text(ideals[i], pos.x+20*i-40, pos.y+10);
    if (reals!=null) for (int i=0; i<reals.length; i++) if (reals[i]!=null)  text(reals[i], pos.x+20*i-40, pos.y+20);
